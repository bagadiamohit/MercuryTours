...
public class FlightFinder {
	...
	String userName="mohit", password="mohit",browserType = "chrome", tripType="round trip", passCount="2", 
	...
	public void flightFinderTest() {
		...
		flightFinder.flighFinder(tripType, passCount, departFrom, fromMonth, fromDay, departTo, toMonth, toDay, serviceClass);
